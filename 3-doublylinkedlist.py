...
class LinkedList:
    ...
    #function to traverse to the end of the linked list and insert node to last
    def to_end(self,n):
    ...
    #function to traverse to a particular position in the linked list and insert node at that position
